...
/**
 * The class Fraction is a datatype for representing fractions.
 * In a/b a being the decimal and b being the fraction.
 * 
 * @author vkolon01
 *
 */
public class Fraction {
     ...
     * @param numerator  
     * @param denominator
     * Takes parameters of type BigInteger and creates a Fraction with a numerator and denominator of type BigInteger.
     */
    public Fraction(BigInteger numerator, BigInteger denominator){
        this.numerator = numerator;
        this.denominator = denominator;
        simplify();  //Every change to the object will force this method to simplify the fraction.
    }
    
    /**
     * @param val
     * Takes parameter of type BigIngeger and creates a Fraction with a numerator of type BigInteger.
     */
     ...
     * @param numerator
     * @param denominator
     * Takes parameters of type long and creates a Fraction with a numerator and denominator of type BigInteger.
     */
    ...
    /**
     * @param val 
     * Takes parameter of type long and creates a Fraction with a numerator of type BigInteger.
     */
     ...
     * 
     * @param val
     * @return Returns −1, 0 or 1 as this Fraction is numerically less than, equal to, or greater than given fraction, respectively.
     */
    public int compareTo(Fraction val){
        return this.numerator.divide(this.denominator).compareTo(val.numerator.divide(val.denominator));
    }
    
    /**
     * 
     * @param val
     * @return Returns true if the two fractions have equal values and false otherwise.
     */
    ...
    /**
     * 
     * @return This method returns 1 if the fraction is positive, 0 if its 0 and -1 when negative.
    ...
    /**
     * This is a private method and only ran by the constructor.
     * The method is ran every time the Fraction object is modified therefore does not need to be called separately.
     */
    ...
    /**
     * This method defines the structure of the object output when called through System.out.print
     */
    ...
    /**
     * @return Returns Fraction by swapping the numerator and denominator with each other.
     */
    ...
    public Fraction min(Fraction val){
      ...
      * @return Fraction
      * This method takes Fraction[] array and adds all the elements together. 
      * Return is a Fraction that is the sum of all elements in the array fractions.
      */
